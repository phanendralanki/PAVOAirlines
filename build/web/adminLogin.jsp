...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="AdminLoginServlet" class="form" id="adForm"  name="form" method="post" onsubmit="return validate()">
                <div class="field">
                    <label for="email">Email</label>
                    <input type="email" name="user_email" id="email" placeholder="Email@gmail.com" autocomplete="off"><br>
                    
                </div>
                <div class="field">
                    <label for="password">Password</label>
                    <input type="password" name="user_password" id="password" placeholder="Enter your password" autocomplete="off"><br>
